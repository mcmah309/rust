...
class Fs {
  ...
  static FutureResult<Uint8List, IoError> read(Path path) => throw UnsupportedError("'read' is not supported on this platform");

  static Result<Uint8List, IoError> readSync(Path path) => throw UnsupportedError("'readSync' is not supported on this platform");

  static FutureResult<ReadDir, IoError> readDir(Path path) => throw UnsupportedError("'readDir' is not supported on this platform");

  static Result<ReadDir, IoError> readDirSync(Path path) => throw UnsupportedError("'readDirSync' is not supported on this platform");

  static FutureResult<Path, IoError> readLink(Path path) => throw UnsupportedError("'readLink' is not supported on this platform");

  static Result<Path, IoError> readLinkSync(Path path) => throw UnsupportedError("'readLinkSync' is not supported on this platform");

  static FutureResult<String, IoError> readToString(Path path) => throw UnsupportedError("'readToString' is not supported on this platform");

  static Result<String, IoError> readToStringSync(Path path) => throw UnsupportedError("'readToStringSync' is not supported on this platform");

  static FutureResult<(), IoError> removeDir(Path path) => throw UnsupportedError("'removeDir' is not supported on this platform");

  static Result<(), IoError> removeDirSync(Path path) => throw UnsupportedError("'removeDirSync' is not supported on this platform");

  static FutureResult<(), IoError> removeDirAll(Path path) => throw UnsupportedError("'removeDirAll' is not supported on this platform");

  static Result<(), IoError> removeDirAllSync(Path path) => throw UnsupportedError("'removeDirAllSync' is not supported on this platform");

  static FutureResult<(), IoError> removeFile(Path path) => throw UnsupportedError("'removeFile' is not supported on this platform");

  static Result<(), IoError> removeFileSync(Path path) => throw UnsupportedError("'removeFileSync' is not supported on this platform");

  static FutureResult<(), IoError> rename(Path path, String newName) => throw UnsupportedError("'rename' is not supported on this platform");

  static Result<(), IoError> renameSync(Path path, String newName) => throw UnsupportedError("'renameSync' is not supported on this platform");
